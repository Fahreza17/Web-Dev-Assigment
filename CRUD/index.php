...
if (isset($_POST['bsimpan'])) {
    if ($_GET['hal'] == "edit") {
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO mhs (nim, nama, alamat, prodi, foto)
        VALUES('$_POST[tnim]','$_POST[tnama]','$_POST[talamat]','$_POST[tprodi]','$_POST[tprodi]')");
        if ($simpan) {
            echo "<script>
...
<body>
    <div class="container">
        ...
        <div class="card border-info mt-3">
            ...
            <div class="card-body">
                <form method="POST" action="" enctyper ="">
                    <div>
                        <label>NIM</label>
                    ...
                    <div>
                        <label>Foto</label>
                        <input type = "file" name = "tfoto" value="<?= @$vfoto ?>">
                    </div>
        ...
        <div class="card border-info mt-3">
            ...
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <?php
                    $no = 1;
                    $tampil = mysqli_query($koneksi, "SELECT * from mhs order by id_mhs desc") or die(mysqli_error($koneksi)) ;
